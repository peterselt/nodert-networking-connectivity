...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Networking_Connectivity.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Networking_Connectivity.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Storage.Streams', 'Windows.Foundation', 'Windows.Networking'];
